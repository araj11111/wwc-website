...
<div class="post-left">
<ul>
<li><img class="img-fluid" src="assets/img/icon/icon-22.svg" alt="Img">Jun
14, 2024</li>
<li><img class="img-fluid" src="assets/img/icon/icon-23.svg" alt="Img">Programming, Web Design</li>
</ul>
</div>
</div>
<h3 class="blog-title"><a href="blog-details.html">Learn Webs Applications Development
from Experts</a></h3>
...
<div class="blog grid-blog">
<div class="blog-image">
<a href="blog-details.html"><img class="img-fluid" src="assets/img/blog/blog-11.jpg" alt="Post Image"></a>
</div>
<div class="blog-grid-box masonry-box">
<div class="blog-info clearfix">
<div class="post-left">
<ul>
<li><img class="img-fluid" src="assets/img/icon/icon-22.svg" alt="Img">Sep
18, 2024</li>
<li><img class="img-fluid" src="assets/img/icon/icon-23.svg" alt="Img">Programming, Courses</li>
</ul>
</div>
</div>
<h3 class="blog-title"><a href="blog-details.html">Programming Content Guideline For
Beginners</a></h3>
<div class="blog-content blog-read">
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.
Sed egestas, ante et vulputate volutpat, eros pede […]</p>
...
<div class="post-left">
<ul>
<li><img class="img-fluid" src="assets/img/icon/icon-22.svg" alt="Img">May
24, 2024</li>
<li><img class="img-fluid" src="assets/img/icon/icon-23.svg" alt="Img">Programming, Courses</li>
</ul>
</div>
</div>
<h3 class="blog-title"><a href="blog-details.html">Expand Your Career Opportunities With
Python</a></h3>
<div class="blog-content blog-read">
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.
...
Suspendisse potenti. Sed egestas, ante et vulputate volutpat, eros pede […]</p>
<a href="blog-details.html" class="read-more btn btn-primary">Read More</a>
</div>
</div>
</div>
...
<h3 class="blog-title"><a href="blog-details.html">Complete PHP Programming Career
Guideline</a></h3>
<div class="blog-content blog-read">
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.
Sed egestas, ante et vulputate volutpat, eros pede […]</p>
...
<div class="post-left">
<ul>
<li><img class="img-fluid" src="assets/img/icon/icon-22.svg" alt="Img">Feb
14, 2024</li>
<li><img class="img-fluid" src="assets/img/icon/icon-23.svg" alt="Img">Programming, Courses</li>
</ul>
</div>
</div>
<h3 class="blog-title"><a href="blog-details.html">Learn Mobile Applications Development
from Experts</a></h3>
<div class="blog-content blog-read">
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.
Sed egestas, ante et vulputate volutpat, eros pede […]</p>
